...
Decomp.ex <- local(get(load("Data/DecompResults_ex_List_INEGI_ill.RData")))
Decomp.ed <- local(get(load("Data/DecompResults_ed_List_INEGI_ill.RData")))
...
source('R/Version with INEGI data/Functions_2.R')
